...
class ServiceProxy:
    ...
    def _call(self, remoteWebServiceMethodName, *args, **kwargs):
        ...
        callinfo = getattr(self, remoteWebServiceMethodName).callinfo
        ...
        #for method in self._methods[remoteWebServiceMethodName]:
        ...
        if callinfo.style == 'rpc':
            request = TC.Struct(None, ofwhat=[], 
                             pname=(callinfo.namespace, remoteWebServiceMethodName), **kw)
            
            response = TC.Struct(None, ofwhat=[], 
                             pname=(callinfo.namespace, remoteWebServiceMethodName+"Response"), **kw)
